...
Vinil::Vinil(const std::string &titlu, const std::string &artist, int anAparitie, const std::string &gen, double pret,
             int rpm)
    : ProdusMuzical(titlu, artist, anAparitie, gen, pret), rpm(rpm) {
